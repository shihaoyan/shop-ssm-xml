...
<div class="container">
    <div class="logo">
        <a href="${ctx}/page/toIndex">后台管理</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd>
                    <a onclick="xadmin.open('切换帐号','/page/toCheckUser')">切换帐号</a></dd>
                <dd>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('统计页面','${ctx}/page/toStatistics')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>统计页面</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('会员列表(静态表格)','/page/member-list')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite></a>
                    </li>
                    <li>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${ctx}/page/toWelcome' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
