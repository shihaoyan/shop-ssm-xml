    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <div class="layui-card">
                <div class="layui-card-header">最新一周新增会员</div>
...
<script type="text/javascript">
    ...
    var option = {
        ...
        series: [{
            name: '用户量',
            data: [${week.monday}, ${week.tuesday}, ${week.wednesday}, ${week.thursday}, ${week.friday}, ${week.saturday}, ${week.sunday}],
            type: 'line',
            smooth: true
        }]
    };
